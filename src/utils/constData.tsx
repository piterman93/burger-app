...
export const menuAdditivesItems: menuAdditiveItem[] = [
  ...
  { id: 2, description: "ST60", price: "12 zł" },
  { id: 3, description: "ST61", price: "12 zł" },
  ...
  { id: 6, description: "ST86", price: "14 zł" },
  { id: 7, description: "ST87", price: "14 zł" },
];

export const menuAdditivesDrinks: menuAdditiveItem[] = [
  { id: 1, description: "coca cola (0.33l/0.5l)", price: "6/8 zł" },
  { id: 2, description: "coca cola zero (0.33l/0.5l)", price: "6/8 zł" },
  { id: 3, description: "fanta (0.33l/0.5l)", price: "6/8 zł" },
  { id: 4, description: "sprite (0.33l/0.5l)", price: "6/8 zł" },
  { id: 5, description: "fuzetee (0.5l)", price: "8 zł" },
  { id: 6, description: "ST72", price: "7 zł" },
  { id: 7, description: "kropla beskidu (0.5l)", price: "5 zł" },
];
